...
<head>
    ...
    <style>
        body {
            margin: 0;
            padding: 0;
            font-family: 'Vazirmatn', sans-serif; /* فونت فارسی زیبا و خوانا */
            background-image: url('background.jpg'); /* نام فایل تصویر پس‌زمینه */
            background-size: cover; /* تصویر کل صفحه را بپوشاند */
            background-position: center; /* تصویر در مرکز قرار گیرد */
            background-attachment: fixed; /* تصویر هنگام اسکرول ثابت بماند */
            color: white; /* رنگ پیش‌فرض متن‌ها سفید */
            display: flex;
            justify-content: center; /* محتوا (جدول) را در مرکز افقی قرار می‌دهد */
            align-items: flex-start; /* محتوا را در بالای صفحه قرار می‌دهد */
            min-height: 100vh; /* حداقل ارتفاع صفحه به اندازه کل ارتفاع ویوپورت */
            overflow-x: hidden; /* جلوگیری از اسکرول افقی */
            padding-top: 50px; /* کمی فاصله از بالای صفحه برای نمایش بهتر */
        }

        /* Overlay برای تیره‌تر کردن تصویر پس‌زمینه */
        body::before {
            content: '';
            position: fixed;
            top: 0;
            ...
            width: 100%;
            height: 100%;
            background-color: rgba(0, 0, 0, 0.8); /* ۶۰% تیرگی */
            z-index: -1; /* قرار گرفتن پشت محتوا */
        }

        .table-container {
            width: 90%; /* عرض کانتینر جدول */
            max-width: 1400px; /* حداکثر عرض جدول */
            margin: 30px auto; /* وسط چین کردن کانتینر */
            background-color: rgba(255, 255, 255, 0.05); /* پس‌زمینه کم‌رنگ برای جدول */
            border-radius: 10px;
            box-shadow: 0 0 20px rgba(0, 0, 0, 0.4); /* سایه برای شیک‌تر شدن */
        ...
        table {
            ...
            table-layout: fixed; /* تنظیم ثابت ابعاد ستون‌ها */
        }

        th, td {
            padding: 15px 10px; /* فاصله داخلی سلول‌ها */
            text-align: center; /* وسط چین کردن متن */
            border: 1px solid rgba(255, 255, 255, 0.3); /* خطوط سفید و نیمه‌شفاف */
            vertical-align: middle; /* وسط چین کردن عمودی محتوا */
        }

        /* استایل سرتیتر جدول */
        th {
            background-color: rgba(0, 0, 0, 0.5); /* پس‌زمینه کمی تیره‌تر برای سرتیتر */
            font-weight: bold;
            color: white; /* رنگ متن سرتیتر سفید */
        }

        /* استایل سطرها */
        tr:nth-child(even) {
            background-color: rgba(255, 255, 255, 0.03); /* رنگ پس‌زمینه برای سطرهای زوج (خیلی کم‌رنگ) */
        }

        tr:nth-child(odd) {
            background-color: rgba(255, 255, 255, 0.01); /* رنگ پس‌زمینه برای سطرهای فرد (خیلی خیلی کم‌رنگ) */
        }
        
        /* اولین سطر (سرتیتر) استایل متفاوتی ندارد */
        tr:first-child {
             background-color: rgba(0, 0, 0, 0.3);
        }


        /* استایل برای سلول تصویر ماشین */
        td img {
            width: 160px; /* عرض ثابت برای عکس ماشین‌ها */
            height: 100px; /* ارتفاع ثابت برای عکس ماشین‌ها */
            object-fit: cover; /* نسبت ابعاد عکس حفظ شود و تصویر برش بخورد */
            border-radius: 5px; /* گوشه‌های گرد برای عکس‌ها */
            display: block; /* برای وسط چین کردن عکس با margin: auto */
        ...
        @font-face {
            ...
            src: url('Vazirmatn-Regular.woff2') format('woff2'),
                 url('Vazirmatn-Medium.woff2') format('woff2'); /* می‌توانید فونت‌های دیگر را هم اضافه کنید */
            font-weight: normal;
            font-style: normal;
        }
        ...
        /* برای اطمینان از اینکه متن‌ها خوانا باشند */
        td {
            font-size: 14px; /* اندازه فونت کمی کوچکتر برای خوانایی بیشتر */
        }
        th {
            font-size: 16px; /* اندازه فونت سرتیتر کمی بزرگتر */
        }

    </style>
    <!-- برای استفاده از فونت وزیر متن، باید فایل‌های فونت را در کنار فایل HTML قرار دهید -->
    <!-- شما می‌توانید فونت‌های Wazirmatn را از وبسایت‌های معتبر دانلود کرده و نام آن‌ها را در بخش @font-face تنظیم کنید -->
    <!-- مثال: Vazirmatn-Regular.woff2, Vazirmatn-Medium.woff2 -->
</head>
<body>
